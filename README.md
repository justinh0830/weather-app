...
## Summary of the project:
  <li> learned how to install and configure gitbash.</li>
  </ul>
  <br>
  <li> learned how to create a new repository in github from a fork.</li>
  </ul>
  <br>
  <li>Initialized the repository using Git:</li>
  <ul>
  ...
  <br> 
  <li>Learned how to commit a repository:</li>
  <ul>
  ...
  <li> Description:</li> 
  <ul>
  This web based application takes in a user search input and using that data request information from two API's one that returns the coordinates of the entered city and another that returns the weather based on the retrieved coordinates.</ul>
  <br>
  <br>
